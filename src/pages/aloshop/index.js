...
const Aloshop = () => {
  return (
    <>
      <div className="hero-aloshop bg-aloshop h-[156px] px-[15px] lg:mt-[63px] lg:h-56">
        <div className="inner text-white lg:flex lg:justify-between lg:px-[400px]">
          <div className="left hidden md:block">
            <div className="breadcrumb pb-5 pt-5 text-[14px]">
              Home / Aloshop
            </div>
            <div className="title">
              <h1 className="text-[36px] font-bold">Alodokter Shop</h1>
            </div>
            <div className="text mb-[0px] text-[18px] font-normal">
              Solusi Aman dan Tepercaya
            </div>
          </div>
          <div className="right pt-4 lg:mt-14">
            <div className="text-sm lg:mb-3 lg:text-right">
              Alamat Pengiriman:
            </div>
            <div className="tambah-alamat center-alo h-auto w-1/2 gap-[8px] rounded-full bg-[#003a9e] px-[12px] py-[8px] lg:w-[170px]">
              <Image
        ...
        <div className="location mt-[10px] lg:px-[400px]">
          <Input
            className={`h-[48px] w-full bg-white bg-[url('/images/cari-dokter/loupe.svg')] bg-[length:16px] bg-[position:12px_center] bg-no-repeat pl-[45px] focus-within:border-[#3570d2] focus-visible:outline-none lg:h-[55px] lg:rounded-[8px]`}
            type={"search"}
            name={"search"}
            id={"search"}
      ...
      {/* new container */}
      <div className="min-h-96 w-full border-0 border-alo bg-[#fafafa] pb-10">
        {/* panel kategori */}
        <div className="category mb-10 border bg-[#ffffff] pb-5 shadow-sm lg:px-[400px]">
        ...
        {/* upload resep obat */}
        <div className="center-alo mb-5 lg:px-[350px]">
        ...
        {/* panel products */}
        <div className="product min-h-10 w-full bg-[#fafafa] pb-5 lg:px-[380px]">
          <div className="header between-alo px-[15px] pb-[10px] pt-[30px]">
        ...
        {/* more button */}
        <div className="px-4 lg:px-[400px]">
          <div className="mb-0 mt-2 rounded-md border border-alo py-[6px] text-center font-bold text-alo">
            Muat Lebih Banyak
          </div>
        </div>
      </div>
      ...
      <div className="mb-10 mt-10 min-h-[100px] w-full bg-white p-[15px]">
        <div className="">
          <div className="">
            ...
            <p className="my-[14px] text-justify text-sm font-normal">
              Alodokter Shop merupakan platform yang bekerja sama dengan partner
              tepercaya untuk menyediakan obat-obatan, produk kesehatan dan
              kecantikan, serta berbagai kebutuhan ibu dan anak, agar pengguna
              aplikasi Alodokter dapat membelinya secara mudah dan aman.
            </p>
